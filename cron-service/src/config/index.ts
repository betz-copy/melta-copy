...
const config = {
  service: {
    workspaceIdHeaderName: env
      .get("WORKSPACE_ID_HEADER_NAME")
      .default("workspace-id")
      .asString(),
  },
  instanceService: {
    url: env.get("INSTANCE_SERVICE_URL").required().asString(),
    baseEntitiesRoute: env
      .get("INSTANCE_SERVICE_BASE_ENTITIES_ROUTE")
      .default("/api/instances/entities")
      .asString(),
    searchOfTemplateRoute: env
      .get("INSTANCE_SERVICE_SEARCH_OF_TEMPLATE_ROUTE")
      .default("/search/template")
      .asString(),
    requestTimeout: env
      .get("INSTANCE_SERVICE_REQUEST_TIMEOUT")
      .default(10000)
      .asIntPositive(),
    searchEntitiesFlowMaxLimit: env
      .get("SEARCH_ENTITIES_FLOW_MAX_LIMIT")
      .default(10000)
      .asIntPositive(),
  },
  templateService: {
    ...
    entities: {
      baseEntitiesRoute: env
        .get("TEMPLATE_SERVICE_ENTITIES_BASE_ROUTE")
        .default("/api/templates/entities")
        .asString(),
    },
    requestTimeout: env
      .get("ENTITY_TEMPLATE_SERVICE_REQUEST_TIMEOUT")
      .default(10000)
      .asIntPositive(),
  },
  rabbit: {
    notificationQueue: env
      .get("NOTIFICATION_QUEUE_NAME")
  ...
  logs: {
    ...
    enableRotateFile: env
      .get("ENABLE_ROTATE_FILE_LOGGING")
      .default("true")
      .asBool(),
    label: env.get("LOG_LABEL").default("gateway").asString(),
    extraDefault: {
      serviceName: env
        .get("LOG_SERVICE_NAME")
    ...
    fileRotateSettings: {
      datePattern: env
        .get("ROTATE_FILE_LOG_DATE_PATTERN")
        .default("YYYY-MM-DD")
        .asString(),
  ...
  workspaceService: {
    ...
    baseRoute: env
      .get("WORKSPACES_SERVICE_BASE_ROUTE")
      .default("/api/workspaces")
      .asString(),
    requestTimeout: env
      .get("WORKSPACES_SERVICE_REQUEST_TIMEOUT")
      .default(10000)
      .asIntPositive(),
  },
  notifications: {
    dateAlertOptions: env
      .get("DATE_NOTIFICATIONS_OPTIONS")
