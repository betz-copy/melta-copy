...
import { RelationshipTemplateModule } from './nest/relationshipTemplate/relationshipTemplate.module';
import { ChildTemplateModule } from './nest/childTemplate/childTemplate.module';
import { CategoryModule } from './nest/category/category.module';
import { ConfigModule } from './nest/config/config.module';
import { PrintingTemplateModule } from './nest/printingTemplate/printingTemplate.module';
import { RuleModule } from './nest/rule/rule.module';
