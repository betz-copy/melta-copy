import { IBasicNotificationQuery, INotification } from '@packages/notification';
...
class NotificationsController extends DefaultController<INotification, NotificationsManager> {
    ...
    async getNotificationById(req: Request, res: Response) {
        ...
        res.json(await this.manager.getNotificationById(notificationId as string));
    }
    ...
    async notificationSeen(req: Request, res: Response) {
        ...
        res.json(await this.manager.notificationSeen(notificationId as string, viewerId));
    }
