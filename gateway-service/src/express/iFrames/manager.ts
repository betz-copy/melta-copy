...
import { IFrame, ISearchIFramesBody, IFramesService, IMongoIFrame, IFrameItem } from '../../externalServices/iFramesService';
...
export class IFrameManager {
    private static filterIFrameWithPermissions(iFrame: IMongoIFrame, allowedEntityTemplates: IMongoEntityTemplatePopulated[]): IMongoIFrame | null {
        const filteredItems = iFrame.items.filter(({ entityTemplate }) => {
