...
class InstancesController {
    ...
    static async viewEntityInstance(req: Request, res: Response) {
        res.json(await InstancesManager.viewEntityInstance(req.params.id, req.body, req.files as Express.Multer.File[], req.user!.id));
    }
