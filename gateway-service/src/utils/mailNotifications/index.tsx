...
//     const sourceEntityTemplate = await EntityTemplateService.getEntityTemplateById(relationshipTemplate.sourceEntityId);
//     const destinationEntityTemplate = await EntityTemplateService.getEntityTemplateById(relationshipTemplate.destinationEntityId);
//     return (
//         <>
...
//     const entityTemplate = await EntityTemplateService.getEntityTemplateById(entity!.templateId);
//     return (
//         <p>
...
//             return RelationshipsTemplateService.getRuleById(brokenRule.ruleId);
//         }),
//     );
