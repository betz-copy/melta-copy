...
const MeltaUpdates: React.FC<MeltaUpdatesProps> = ({
	open,
	handleClose,
	meltaUpdates: { details, description },
}) => {
				...
				<DialogActions>
					...
					>
						<Typography color="white">
							{i18next.t("meltaUpdates.confirmation")}
						</Typography>
					</Button>
				</DialogActions>
			</Dialog>
