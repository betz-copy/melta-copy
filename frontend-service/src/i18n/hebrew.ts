...
export default {
    ...
    wizard: {
        ...
        rule: {
            ...
            todayVariableInfo:
                'השימוש בפונקציה TODAY( ) היא שהנוסחא תרוץ על הישות כל יום מחדש (בלילה) כדי לראות אם נכשל. לדוגמא חוק mathTest.date<TODAY( )-14 יבדק כל יום, ויכשל כאשר התאריך 14 יום לפני המבחן.\nשים לב! אין להשתמש בפונקציה בתוך לולאות קשר (ALL/SOME), מפני שהחוק יאט את המערכת כי רץ על כל הישויות בטבלה כל לילה לבדוק אם ישות כלשהי נכשלת.',
            actions: {
                warning: 'אזהרה',
                enforcement: 'אכיפה',
                indicator: 'חיווי',
