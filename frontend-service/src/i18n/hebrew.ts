import { ActionTypes, WorkspaceTypes } from '@microservices/shared';
...
export default {
    ...
    permissions: {
        ...
        permissionsOfUserDialog: {
            ...
            permissionsManagement: 'הרשאות',
            templatesManagement: 'תבניות',
    ...
    wizard: {
        ...
        unit: {
            createTitle: 'יצירת יחידה',
            updateTitle: 'עריכת יחידה',
            createdSuccessfully: 'יחידה נוצרה בהצלחה',
            editedSuccessfully: 'יחידה עודכנה בהצלחה',
            failedToCreate: 'נכשל ליצור יחידה',
            failedToEdit: 'נכשל בעריכת יחידה',
            addUnitBelow: 'הוספת יחידת בן',
            disabledSuccessfully: 'יחידה הושבתה בהצלחה',
            failedToDisable: 'נכשל להשבית יחידה',
            parentUnit: 'יחידת אב',
            disabled: 'מושבתת',
            duplicateUnitError: 'קיימת יחידה עם שם זה',
            cyclicalError: 'יחידת האב החדשה תהפוך את ההיררכיה למעגלית',
            disabledError: 'יחידה מופעלת לא יכול להיות תחת יחידה מושבתת',
            unitTree: 'עץ יחידות',
            header: {
                show: 'הצג',
                hide: 'הסתר',
                disabledUnits: 'יחידות מושבתות',
                expand: 'פתח',
                collapse: 'סגור',
            },
            warning: {
                disable: 'השבתת יחידה תשבית גם את כל תתי היחידות שלה',
                enable: 'האם להפעיל גם את כל תתי היחידות?',
            },
        },
        printingTemplate: {
