...
export default {
    ...
    dashboard: {
        ...
        charts: {
            onEditDialog: {
                title: 'בחרת לערוך תרשים אשר מופיע בעמוד נוסף',
                body: 'תרשים זה מופיע בעמוד הבית ובעמוד התרשימים של הייישות. שינויים בפרטי התרשים והגדרות הסינון יחולו על כלל המופעים',
            },
            onDeleteDialog: {
                title: 'בחרת למחוק תרשים',
                body: 'תרשים זה מופיע בעמוד הבית ובעמוד התרשימים של היישות. מחיקת התרשים תמחק את כלל המופעים',
            },
        ...
        dialogs: {
            delete: {
                ...
                body: 'הפריט ימחק מהמסך הראשי עבורך ועבור כל מי שמורשה לצפות בו. למחוק את ה{{type}}?',
            },
        },
        itemType: {
            table: 'טבלה',
