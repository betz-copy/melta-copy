    ...
    return (
        <Grid container direction="column" spacing={1}>
            <Grid item>
                ...
                <Typography display="inline">
                    {i18next.t(`processStatusUpdateNotification.${step ? 'step' : 'process'}`)}
                </Typography>
            ...
            <Grid item>
                ...
                {step && <>
                    ...
                    <Typography display="inline" >
                        {i18next.t('processStatusUpdateNotification.stepStatusPart2') + ' '}
                    </Typography>
                </>}
                <Typography display="inline" fontWeight="bold">
                    {process.name + ' '}
                ...
                <Typography display="inline">
                    {i18next.t('processStatusUpdateNotification.updatedTo')}
                </Typography>
                <Typography display="inline" fontWeight="bold">
