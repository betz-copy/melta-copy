...
export const OpenDrawerButton: React.FC = () => {
    ...
    return (
        <svg width="18" height="89" viewBox="0 0 18 89" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'scale(1.75)' }}>
            <path
...
export const CloseDrawerButton: React.FC = () => {
    ...
    return (
        <svg width="19" height="89" viewBox="0 0 19 89" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'scale(1.75)' }}>
            <path
