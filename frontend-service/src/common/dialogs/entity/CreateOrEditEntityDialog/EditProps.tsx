        ...
        return (
            <Grid container width="100%">
                <Grid container flexDirection="column" width="100%">
                    <Box width="100%" sx={{
                        position: 'sticky', top: 0, zIndex: 3, backgroundColor: darkMode ? '#1e1e1e' : 'white', paddingTop: '16px'
                    }}>
                        <Grid container flexDirection="row" flexWrap="nowrap" justifyContent="space-between">
                            {showTitle && (
                                <Grid>
                                    <BlueTitle
                                        title={`${i18next.t(`actions.${isEditMode ? 'edit' : 'create'}ment`)} ${values.template?.displayName || i18next.t('wizard.entity.createNewEntity')
                                            }`}
                                        component="h6"
                                        variant="h6"
                    ...
                    <Box>
                        <Grid marginTop="20px" marginBottom="20px" style={{ maxHeight: '48rem' }}>
