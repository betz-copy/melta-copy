...
// import { Dialog, DialogTitle, DialogContent, IconButton, Grid, CardActions, Fab, Box, Typography } from '@mui/material';
...
// import { IProcessSingleProperty, IProcessTemplateMap } from '../../../interfaces/processes/processTemplate';
...
//                         {/* <GeneralDetails detailsFormikData={detailsFormikData} onNext={handleNext} onBack={handleBack} processInstance={undefined} /> */}
//                     </Grid>
//                     <Grid item>
...
//                             >
//                                 {/* {Object.keys(pickProcessFieldsPropertiesSchema(values.template.details).properties).length !== 0 && (
//                                     <SchemaForm {...{ viewMode: false, values, errors, touched, setFieldValue, setFieldTouched, toPrint: false }} />
//                                 )} */}
//                                 {Object.keys(templateFileProperties!).length !== 0 && (
//                                     <FileAttachments
//                                         {...{
