...
import type { IEntityTemplateMap } from "../../../interfaces/entityTemplates";
import type { IPolygonSearchResult } from "../../../interfaces/location";
...
export const useCesiumTooltip = ({
	viewerRef,
	darkMode,
	entityTemplateMap,
	searchedEntitiesPolygons,
	filteredPolygons,
}: UseCesiumTooltipParams) => {
	...
	useEffect(() => {
		...
		handler.setInputAction(
			({ endPosition }: Cesium.ScreenSpaceEventHandler.MotionEvent) => {
				...
				const nodeData: IEntity | undefined =
					entity?.properties?.__node?.getValue?.() ?? entity.properties?.__node;
					...
					root.render(
						<QueryClientProvider client={queryClient}>
							<EntityTooltip
								darkMode={darkMode}
								entity={nodeData}
								entityTemplates={entityTemplateMap}
