...
export interface IProcessTemplatePopulated
...
export interface IMongoProcessTemplatePopulated
  extends IProcessTemplatePopulated {
  _id: string;
  createdAt: Date;
  updatedAt: Date;
}

export interface IMongoProcessTemplateReviewerPopulated
...
export interface IProcessTemplateSearchProperties
  extends IBaseSearchProperties {
  displayName?: string;
}

export interface ISearchProcessTemplatesBody
  extends Partial<IBaseSearchProperties> {
  displayName?: string;
}
