...
export interface IMongoProcessInstancePopulated
  extends IProcessInstancePopulated {
  _id: string;
  createdAt: Date;
  updatedAt: Date;
}

export interface IMongoProcessInstanceReviewerPopulated
  extends Omit<IMongoProcessInstance, "steps"> {
  steps: IMongoStepInstancePopulated[];
}

export type CreateProcessReqBody = Pick<
  IProcessInstance,
  "templateId" | "name" | "details" | "startDate" | "endDate"
> & {
...
export interface IProcessInstanceSearchProperties
