...
const relationshipTemplates: IMongoRelationshipTemplate[] = [
    ...
    },
    {
        ...
        createdAt: new Date(3333, 10, 1),
        updatedAt: new Date(4444, 10, 1),
        isProperty: true,
    },
    {
        ...
        createdAt: new Date(5555, 10, 1),
        updatedAt: new Date(6666, 10, 1),
        isProperty: true,
    },
    {
        ...
        createdAt: new Date(7777, 10, 1),
        updatedAt: new Date(8888, 10, 1),
        isProperty: true,
    },
    {
        ...
        createdAt: new Date(9999, 10, 1),
        updatedAt: new Date(1122, 10, 1),
        isProperty: true,
    },
    {
        ...
        createdAt: new Date(1212, 10, 1),
        updatedAt: new Date(2121, 10, 1),
        isProperty: true,
    },
    {
