...
export type IPermissionsPermission =
  IBasePermission<PermissionType.permissions>;
...
export type IInstancesPermission = IBasePermission<
  PermissionType.instances,
  typeof IInstancePermissionOrderedHierarchy
>;
