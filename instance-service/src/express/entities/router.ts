...
const entityController = createController(EntityController)<EntityController>;

const entityValidatorController = createController(EntityValidator)<EntityValidator>;
