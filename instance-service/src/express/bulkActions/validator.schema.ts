...
export const IActionSchema = Joi.object({
    actionType: Joi.string().valid('create-relationship', 'delete-relationship', 'create-entity', 'duplicate-entity', 'update-entity', 'update-status').required(),
    actionMetadata: Joi.object().when('actionType', {
